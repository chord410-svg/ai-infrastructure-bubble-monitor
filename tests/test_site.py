...
class SiteTests(unittest.TestCase):
    ...
    def test_incomplete_history_and_planned_indicators_have_clear_states(self):
        ...
        self.assertIn("weeklyHistory", script)
        self.assertIn("valid.length < 3", script)
        self.assertIn("renderSnapshotStatus", script)
        self.assertIn("context.arc", script)
        self.assertIn("moduleEmptyState", script)
        self.assertIn("availableModules", script)
        self.assertIn("missingModules", script)
